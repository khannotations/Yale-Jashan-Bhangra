class MainController < ApplicationController
  ...
  protected
    ...
    def content_header selected
      ...
      string += "<li class='pull-right text' style='padding-top: 10px;'><fb:like href='https://www.facebook.com/pages/Yale-Jashan-Bhangra/190308261019210' send='false' layout='button_count' width='150' show_faces='false'></fb:like></li>"
      string += "</div></div>"
      string
    end
